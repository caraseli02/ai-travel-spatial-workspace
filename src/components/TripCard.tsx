        ...
        <div className="relative h-48 overflow-hidden">
          ...
          {isNew && (
            <motion.div
              initial={{ scale: 0 }}
              animate={{ scale: 1 }}
              className="absolute top-3 right-3 group-hover:right-12 transition-all duration-300 flex items-center gap-1 rounded-full bg-violet-500/90 px-2.5 py-1.5 text-[11px] font-semibold text-white backdrop-blur-md shadow-lg shadow-violet-500/20"
            >
          ...
          <button
            ...
            className="absolute top-3 right-3 opacity-0 group-hover:opacity-100 transition-opacity duration-300 w-8 h-8 rounded-full flex items-center justify-center bg-black/60 hover:bg-rose-600 text-white backdrop-blur-md shadow-lg border border-white/10 cursor-pointer z-10"
            title="Delete Trip"
          >
          ...
          <div className="grid grid-cols-2 gap-3 text-sm text-slate-400">
            <div className="flex items-center gap-2 min-w-0">
              ...
              <span className="truncate font-medium">
                {trip.dates ? formatDate(trip.dates.start) : 'Flexible'}
              </span>
            </div>
            <div className="flex items-center gap-2 min-w-0">
      ...
      <div className="p-4 pt-0">
        <div className="flex items-center pt-2 border-t border-white/[0.04]">
          <button
            ...
            className="w-full flex items-center justify-center gap-1.5 rounded-xl bg-white/[0.03] hover:bg-white/[0.07] text-slate-200 hover:text-white border border-white/[0.06] hover:border-white/[0.12] py-2.5 text-xs font-semibold transition-all cursor-pointer shadow-sm active:scale-[0.98]"
          >
            View Details
